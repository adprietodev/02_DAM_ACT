...
public class View extends JFrame {
	...
	public void openRegister() {
        ...
        registerFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // Cierra solo la ventana secundaria al hacer clic en cerrar
